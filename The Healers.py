...
class Healer(Warrior):
    ...
    def heal(self,role):
        role.health += 2
        role.health = min(role.health,role.healthmax)
        ...
        while army1.group[0].health > 0 and army2.group[0].health > 0:
            ...
            if isinstance(army1.group[0],Lancer) and len(army2.group) >= 2:
                ...
                if army2.group[1].health <= 0:
                    ...
                    army2.group.pop(1)
            if len(army1.group) >= 2 and isinstance(army1.group[1],Healer):
                army1.group[1].heal(army1.group[0])
            ...
            if isinstance(army2.group[0],Lancer) and len(army1.group) >= 2:
                ...
                if army1.group[1].health <= 0:
                    ...
                    army1.group.pop(1)
            if len(army2.group) >= 2 and isinstance(army2.group[1],Healer):
                army2.group[1].heal(army2.group[0])
